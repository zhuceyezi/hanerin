...
from utils.maimaidx_music import total_list, get_cover_len5_id
...
class DrawBest(object):
    ...
    def __init__(self, sdBest:BestList, dxBest:BestList, userName:str):
        ...
        self.pic_dir = '/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/mai/pic/'
        self.cover_dir = '/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/mai/cover/'
    ...
    def _drawBestList(self, img:Image.Image, sdBest:BestList, dxBest:BestList):
        ...
        titleFontName = '/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype('/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text((8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white', font)
            font = ImageFont.truetype('/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype('/home/aleafy/PycharmProjects/Hanerin-Napcat/utils/static/adobe_simhei.otf', 14, encoding='utf-8')
